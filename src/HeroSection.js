          ...
          <div className="row">
            <div className="col">
              ...
              <p>
                ...
                Blanditiis, maiores ipsam nihil inventore eligendi maxime
                voluptatem commodi veniam vitae eius impedit quisquam cupiditate
                omnis?{" "}
              </p>
              <a href="/contact">
                <button
                  type="button"
                  className="btn head-btn btn-primary btn-lg"
                >
                  Large button
                </button>
              </a>
